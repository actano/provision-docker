...
class DockerClient {
  ...
  login(registryHost, registryUsername, password) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const exists = yield _this6.sshClient.fileExists(`/home/${_this6.username}/.docker/config.json`);
      if (exists) {
        console.log(_safe2.default.green('already logged in'));
        return;
      }
      ...
      yield _this6.sshClient.writeToFile(JSON.stringify(auth), `/home/${_this6.username}/.docker/config.json`);
    })();
  }
